...
export const modules = {
  customers: {
    ...
    fields: [
      ...
      { name: "tier", label: "Tier", type: "select", options: ["Bronze", "Silver", "Gold", "Platinum"], table: true, badge: true },
...
export const navSections: { label: string; items: { to: string; label: string; icon: string }[] }[] = [
  {
    ...
    items: [
      ...
      { to: "/setup", label: "Easy setup", icon: "ListChecks" },
      { to: "/front-desk", label: "Front desk", icon: "UserRound" },
    ],
  },
  {
    label: "Front desk",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/coupons", label: "Coupon management", icon: "Ticket" },
      { to: "/prize-wheel", label: "Prize wheel", icon: "Sparkles" },
      { to: "/scratch-card", label: "Scratch card", icon: "Layers" },
      { to: "/memberships", label: "Memberships", icon: "CreditCard" },
      { to: "/walk-in", label: "Walk-in (public)", icon: "UserRound" },
