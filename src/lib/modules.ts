...
const outlets = ["All", "Bandra Flagship", "Koregaon Park", "Indiranagar", "Salt Lake"];
const staffNames = ["Ritu Nair", "Imran Shaikh", "Priya Deshmukh", "Meera Rao", "Kunal Shah"];
const customerNames = [
  "Aarti Sharma",
  "Neha Kulkarni",
  "Rohan Mehta",
...
export const modules = {
  customers: {
    ...
    fields: [
      ...
      { name: "points", label: "Loyalty points", type: "number", table: true },
  ...
  services: {
    ...
    subtitle: "Services, pricing, GST slabs and commission rates.",
    idPrefix: "S-",
    fields: [
  ...
  inventory: {
    ...
    fields: [
      ...
      { name: "outlet", label: "Outlet", type: "select", options: outlets, table: true },
      { name: "stock", label: "Stock on hand", type: "number", table: true },
  ...
  shifts: {
    key: "shifts",
    title: "Shifts & Roster",
    subtitle: "Weekly roster planning per outlet.",
    idPrefix: "SH-",
    fields: [
  ...
  attendance: {
    key: "attendance",
    title: "Attendance",
    subtitle: "Daily check-in / check-out log.",
    idPrefix: "AT-",
    fields: [
      { name: "staff", label: "Staff", type: "select", options: staffNames, table: true },
      { name: "date", label: "Date", type: "date", table: true },
  ...
  leaves: {
    ...
    subtitle: "Leave applications and approvals.",
    idPrefix: "LV-",
    fields: [
      { name: "staff", label: "Staff", type: "select", options: staffNames, table: true },
      {
      ...
      { name: "days", label: "Days", type: "number", table: true },
      {
        name: "status",
        label: "Status",
        type: "select",
  ...
  loyalty: {
    ...
    fields: [
      ...
      { name: "earnRate", label: "Earn rate", table: true },
      { name: "redeemValue", label: "Redemption value", table: true },
  ...
  memberships: {
    key: "memberships",
    title: "Memberships",
    subtitle: "Plan enrollments, validity and redemption usage.",
    idPrefix: "MP-",
    fields: [
      { name: "plan", label: "Plan", table: true },
      { name: "customer", label: "Member", type: "select", options: customerNames, table: true },
      { name: "price", label: "Price", type: "number", money: true, table: true },
      ...
      { name: "used", label: "Redemptions used", type: "number", table: true },
      {
        name: "status",
        label: "Status",
        type: "select",
  ...
  users: {
    ...
    fields: [
      ...
      { name: "email", label: "Email", table: true },
      {
        ...
        label: "Role",
        type: "select",
        options: ["Owner", "Franchise Manager", "Outlet Manager", "Stylist", "Receptionist"],
        table: true,
        badge: true,
      },
      { name: "outlet", label: "Outlet", type: "select", options: outlets, table: true },
      { name: "permissions", label: "Permissions", table: true },
